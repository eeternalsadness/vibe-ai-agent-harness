...
- [x] **Update memory agent instructions** — sanitized input, tagged format, semantic dedup, capture signals
- [x] **Rewrite plugin** — remove remember(), add session.idle with sanitization + Memory.md-based dedup, 100 items

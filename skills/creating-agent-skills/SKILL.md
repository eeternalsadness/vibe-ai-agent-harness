...
If OpenCode: Follow [reference/opencode-conventions.md](reference/opencode-conventions.md)
...
For platform-specific requirements (metadata format, file naming, save locations):
- **OpenCode:** [reference/opencode-conventions.md](reference/opencode-conventions.md)
- **Other platforms:** Request conventions from user
